...
def seed_disciplines():
    ...
    cur.executemany(sql, zip(disciplines, iter(randint(1, TEACHERS_NUMBER) for _ in range(len(disciplines)))))
...
def seed_grades():
    ...
    for day in list_dates:
        ...
        random_students = [randint(1, STUDENTS_NUMBER) for _ in range(5)]
